...
//            super.onPostExecute(result);
            ...
            for(int i = 0;i < tableRows.length; i++){
                ...
                text.setLayoutParams(new android.widget.TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT,
...
//                text.setTextColor(Color.parseColor("#000000"));
            ...
            for(int i=0; i < billRows.length; i++) {
                ...
                bill.setLayoutParams(new android.widget.TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT,
                        TableRow.LayoutParams.WRAP_CONTENT));
